        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(httpRequests ->
                        httpRequests.requestMatchers("/api/v1/flights/delete-flight/{Id}").hasAuthority(String.valueOf(Role.ADMIN))
                                .requestMatchers(
                                        "/api/v1/auth/**","/api/v1/flights/availableFlight","/api/v1/flights/departing-flights", "/api/v1/flights/returning-flights","/api/v1/flights/all-returning-flights","/api/v1/flights/all-departing-flights", "/api/v1/flights/fetch-all-flights", "/api/v1/auth/passenger-sign-up", "/api/v1/auth/verifyRegistration", "/api/v1/auth/changePassword").permitAll()
                                .requestMatchers(
